    ...
    <div class="container">
        ...
        <form method="post">
            ...
            <div class="radio-group">
                ...
                <label><input type="radio" name="typ" value="udalosť" <?= isset($edit_event) && $edit_event['typ'] === 'udalosť' ? 'checked' : '' ?>> Udalosť</label>
                <label><input type="radio" name="typ" value="športová udalosť" <?= isset($edit_event) && $edit_event['typ'] === 'športová udalosť' ? 'checked' : '' ?>> Športová udalosť</label>
                <label><input type="radio" name="typ" value="kurz" <?= isset($edit_event) && $edit_event['typ'] === 'kurz' ? 'checked' : '' ?>> Kurz</label>
                <label><input type="radio" name="typ" value="kultúrne podujatie" <?= isset($edit_event) && $edit_event['typ'] === 'kultúrne podujatie' ? 'checked' : '' ?>> Kultúrne podujatie</label>
                <label><input type="radio" name="typ" value="hudba" <?= isset($edit_event) && $edit_event['typ'] === 'hudba' ? 'checked' : '' ?>> Hudba</label>
                <label><input type="radio" name="typ" value="kino" <?= isset($edit_event) && $edit_event['typ'] === 'kino' ? 'checked' : '' ?>> Kino</label>
                <label><input type="radio" name="typ" value="kostol" <?= isset($edit_event) && $edit_event['typ'] === 'kostol' ? 'checked' : '' ?>> Kostol</label>
            </div>
